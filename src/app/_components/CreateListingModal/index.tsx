...
> = {
    ...
    vehicle: {
        sidebar: "bg-[var(--color-brand)]",
        selectedBorder: "border-[var(--color-brand)]",
        selectedBg: "bg-[var(--color-brand-muted)]",
        selectedText: "text-[var(--color-brand)]",
        selectedIconBg: "bg-[var(--color-brand-muted)]",
        iconStroke: "var(--color-brand)",
        inputFocus: "focus-within:border-[var(--color-brand)] focus-within:ring-1 focus-within:ring-[var(--color-brand)]",
        addMoreHover: "hover:border-[var(--color-brand)] hover:text-[var(--color-brand)]",
        publishBtn: "bg-[var(--color-brand)] hover:bg-[var(--color-brand-dark)]",
    },
};
