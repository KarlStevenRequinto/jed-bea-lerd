 ...
 *
 * This client is specifically designed for Next.js middleware
 * to handle session refresh and authentication checks.
 */
...
export async function updateSession(request: NextRequest) {
  ...
  // Protect routes - add your protected route patterns here
  const protectedRoutes = ['/profile', '/products', '/product-details']
